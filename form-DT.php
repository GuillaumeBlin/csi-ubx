<form id="csi" action="<?php echo str_replace("/load_user/","/form_save_DTReport/",$_SERVER['REQUEST_URI']);?>" method="POST">
    ...
    <h3>Bilan annuel sur l'avancement de la thèse</h3>
            ...
            <!-- 2eme année-->
    <?php 
        if(intval(substr($defense["niveau_Etud"],0,1))==2){
    ?>
    ...
    ?>
            ...
            <!-- 3eme année-->
            <?php 
        if(intval(substr($defense["niveau_Etud"],0,1))>=3){
    ?>
            <div>
