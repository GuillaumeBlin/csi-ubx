<form action="<?php echo str_replace("/load_user/","/form_save_PhDReport/",$_SERVER['REQUEST_URI']);?>" method="POST">
    ...
    ?>
        <h4>Thèse avec activités complémentaires (enseignement, médiation, valorisation expertise)</h4>
            <span>
    ...
    <h3>ANNÉE DU CSI</h3>
        <h4>CSI pour réinscription en année</h4>                
    ...
    <h3>COMPOSITION DU COMITÉ DE SUIVI INDIVIDUEL (hors direction de thèse)</h3>
            ...
            <h5>Unité de recherche/établissement</h5>
    ...
    <h3>1 -&nbsp; BILAN ANNUEL AVEC LA DIRECTION DE THÈSE</h3>
    ...
    <h3>2- BILAN ANNUEL DE LA RELATION AVEC L’UNITÉ DE RECHERCHE</h3>
    ...
    <h3>3 -&nbsp;AVIS GÉNÉRAL SUR L’ANNÉE ÉCOULÉE</h3>
