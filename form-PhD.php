...
<div class="rendered-form">
    ...
    <div class="formbuilder-date form-group field-date-1711061138770">
        ...
        <input type="date" class="form-control" name="date-1711061138770" access="false" id="date-1711061138770" value="<?php date('Y-m-d', strtotime(str_replace('-','/',$defense["these_date_1inscription"]))); ?> ">
    </div>
