<form id="csi" <?php if ($report_read_only == false) { ?> action="<?php echo str_replace("/load_user/", "/form_save_PhDReport/", $_SERVER['REQUEST_URI']); ?>" method="POST" <?php } ?>>
    ...
    <span>
        <input name="TypeDeFinancement" value="Ministère" type="radio" <?php if ($report["TypeDeFinancement"] == "Ministère") {
                                                                            echo "checked";
                                                                        } ?>>
        <label>Ministères</label>
    </span>
    <span>
        <input name="TypeDeFinancement" value="CIFRE" type="radio" <?php if ($report["TypeDeFinancement"] == "CIFRE") {
                                                                        echo "checked";
                                                                    } ?>>
        <label>CIFRE</label>
    </span>
    <span>
        <input name="TypeDeFinancement" value="COFRA" type="radio" <?php if ($report["TypeDeFinancement"] == "COFRA") {
                                                                        echo "checked";
                                                                    } ?>>
        <label>COFRA</label>
    </span>
    <span>
        <input name="TypeDeFinancement" value="CD Droit Privé" type="radio" <?php if ($report["TypeDeFinancement"] == "CD Droit Privé") {
                                                                                echo "checked";
                                                                            } ?>>
        <label>CD Droit Privé</label>
    </span>
    <div>
        <input name="TypeDeFinancement" value="Autre" type="radio" <?php if ($report["TypeDeFinancement"] == "Autre") {
                                                                        echo "checked";
                                                                    } ?>>
        <label>Autre
        </label>
    ...
    <div id="PhD_ExtraActivite_NbH_div" <?php if (!array_key_exists("PhD_ExtraActivite", $report) || $report["PhD_ExtraActivite"] == "Non") {
