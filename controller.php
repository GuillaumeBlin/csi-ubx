        ...
        if ($val) {
            ...
            if(strcmp($user,"DT")==0){
             /*   if(!isset($_REQUEST["pwd"])||strcmp($_REQUEST["pwd"],$this->pwd)!=0){
                ...
                echo "<script>if(prompt(\"Please enter your credential\")!='".$this->pwd."'){window.stop();window.location.replace('https://doctorat.u-bordeaux.fr/page-de-saisie-des-rapports-de-csi');}</script>";
            }
