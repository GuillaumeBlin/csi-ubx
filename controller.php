...
class Controller extends BlockController
{
    ...
    public function action_show_AllReport($bID = false, $type)
    {
        ...
        $report_data = $statement->fetchAll();         
        echo '<script type="text/javascript" src="/concrete/js/jquery.js">document.addEventListener("load", (event) => { alert("chargement terminé");});</script>';
    ...
    public function action_show_EmptyDTReport($bID = false)
    {
        $this->action_show_Report($this->bID, 'DT', true);
    }

    public function action_show_EmptyCSIReport($bID = false)
    {
        $this->action_show_Report($this->bID, 'CSI', true);
    }
